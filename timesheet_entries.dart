...
class _TimesheetState extends State<Timesheet> {
  ...
  List hval = [false, false, false, false, false];
  List bg = [
    Colors.white,
    Colors.white,
    Colors.white,
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Checkbox(
                                        ...
                                        onChanged:hval[index]==true?null: (bool value) {
...
//  List approved_data = [];
  ...
  void color_approve(index) {
//    if ((h[index] == Colors.white && bg[index] == Colors.green) ||
//        (h[index] == Colors.white && bg[index] == Colors.red)) {
//      print("it should not change color");
//    } else
      if (hval[index]==false){
    if(empdata['dates'][index]['is_active'] == true) {
      h[index] = Colors.white;
      bg[index] = Colors.green;
      String approved_data=
      parseDuration(
                                      empdata['dates'][index]['total']);
                                  approve_value = Duration(
                                          minutes:
                                              duration(approved_data)
                                                  .abs()
                                                  .inMinutes) +
                                      approve_value;
      hval[index] = true;
  ...
  void color_deny(index) {
//    if ((h[index] == Colors.white && bg[index] == Colors.green) ||
//        (h[index] == Colors.white && bg[index] == Colors.red)) {
//      print("it should not chnage color");
//    } else
  if(hval[index]==false){
      if (empdata['dates'][index]['is_active'] == true) {
      h[index] = Colors.white;
